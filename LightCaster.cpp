...
//  float windowHeight = 800.0f;
//  GLFWwindow *window =
//      glfwCreateWindow(windowWidht, windowHeight, "Testing", NULL, NULL);
//  if (window == NULL)
//  {
...
//  unsigned char *data =
//      stbi_load(imageLocation, &widht, &height, &urchannel, 0);
//  if (data)
//  {
//    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, widht, height, 0, GL_RGBA,
...
//  // Directional Light
//  // shader.setVec3("light.direction", directionalLightDirection);
//  // Point Light
//  shader.setFloat("light.constant", 1.0f);
//  shader.setFloat("light.linear", 0.09f);
//  shader.setFloat("light.quardatic", 0.032f);
//
