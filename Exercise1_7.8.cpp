////Q. Make sure only the happy face looks in the other/reverse 
//// direction by changing the fragment shader
//
//#include <glad/glad.h>
...
//"void main()\n"
//"{\n"
//"   FragColor = mix(texture(ourTexture1,texCoord),texture(ourTexture2,vec2(-texCoord.x,texCoord.y)),0.5f);\n"
//"   "
//"}\n\0";
////
//int main()
